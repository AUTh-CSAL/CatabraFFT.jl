...
@inline function fft7_shell_ivdep!(y::AbstractVector{Complex{T}}, x::AbstractVector{Complex{T}}, s::Int) where {T <: AbstractFloat}
...
@inline function fft7_shell_y_ivdep!(y::AbstractVector{Complex{T}}, s::Int) where {T <: AbstractFloat}
    Cp1, Sp1 = T(Cp1_DEFAULT), T(Sp1_DEFAULT)
    Cp2, Sp2 = T(Cp2_DEFAULT), T(Sp2_DEFAULT)
    Cp3, Sp3 = T(Cp3_DEFAULT), T(Sp3_DEFAULT)
    @inbounds @simd ivdep for q in 1:s
...
@inline function fft7_shell_layered_ivdep!(y::AbstractVector{Complex{T}}, x::AbstractVector{Complex{T}}, s::Int, n1::Int, theta::Float64) where {T<: AbstractFloat}
    Cp1, Sp1 = T(Cp1_DEFAULT), T(Sp1_DEFAULT)
    Cp2, Sp2 = T(Cp2_DEFAULT), T(Sp2_DEFAULT)
    Cp3, Sp3 = T(Cp3_DEFAULT), T(Sp3_DEFAULT)
