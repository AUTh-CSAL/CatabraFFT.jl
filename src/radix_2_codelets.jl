...
# Core FFT codelets
@inline function fft16_shell_layered_ivdep!(y::AbstractVector{Complex{T}}, x::AbstractVector{Complex{T}}, s::Int, n1::Int, theta::Float64) where T <: AbstractFloat
    INV_SQRT2 = T(INV_SQRT2_DEFAULT)
    Cp_3_8 = T(Cp_3_8_DEFAULT)
    Sp_3_8 = T(Sp_3_8_DEFAULT)
    @inbounds @simd ivdep for p in 0:(n1-1)
        w1p = cispi(-p * theta)
        w2p = w1p * w1p
        w3p = w1p * w2p
        w4p = w2p * w2p
...
@inline function fft16_shell_ivdep!(y::AbstractVector{Complex{T}}, x::AbstractVector{Complex{T}}, s::Int) where T <: AbstractFloat
    INV_SQRT2 = T(INV_SQRT2_DEFAULT)
    Cp_3_8 = T(Cp_3_8_DEFAULT)
    Sp_3_8 = T(Sp_3_8_DEFAULT)
    @inbounds @simd ivdep for q in 1:s
...
@inline function fft16_shell_y_ivdep!(y::AbstractVector{Complex{T}}, s::Int) where T <: AbstractFloat
    INV_SQRT2 = T(INV_SQRT2_DEFAULT)
    Cp_3_8 = T(Cp_3_8_DEFAULT)
    Sp_3_8 = T(Sp_3_8_DEFAULT)
    @inbounds @simd ivdep for q in 1:s
...
@inline function fft8_shell_layered_ivdep!(y::AbstractVector{Complex{T}}, x::AbstractVector{Complex{T}}, s::Int, n1::Int, theta::Float64) where T <: AbstractFloat
    INV_SQRT2 = T(INV_SQRT2_DEFAULT)
...
@inline function fft8_shell_y_ivdep!(y::AbstractVector{Complex{T}}, s::Int) where T <: AbstractFloat
    INV_SQRT2 = T(INV_SQRT2_DEFAULT)
    @inbounds @simd ivdep for q in 1:s
...
@inline function fft4_shell_y_ivdep!(y::AbstractVector{Complex{T}}, s::Int) where T <: AbstractFloat
    @inbounds @simd ivdep for q in 1:s
...
@inline function fft2_shell_y_ivdep!(y::AbstractVector{Complex{T}}, s::Int) where T <: AbstractFloat
    @inbounds @simd ivdep for q in 1:s
        a, b = y[q], y[q+s]
        y[q] = a + b
        y[q+s] = a - b
